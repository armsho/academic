        ...
        <div className="max-w-5xl w-full flex flex-col lg:flex-row items-center lg:items-start gap-10">
          ...
          <div className="flex-1 mt-6 lg:mt-0 text-left px-4 sm:px-6 md:px-0">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
             There seems to be a demand for a polished, fully functional template that would be useful to professors, researchers, and students. Such a site would need to strike a fine balance between simplicity, usability, and beauty and include the necessary features to showcase one’s academic work. To this end, I designed and developed this template with a focus on simplicity, customizability, and ease of upkeep. The design effectively displays one’s publications, current and completed projects, teaching, and various professional accomplishments in a clean and organized manner. I anticipate that this template provides a solid starting point for establishing a visible presence on the web for academic purposes. Feel free to help this template evolve and have access to the code on <a href="https://github.com/armsho/academic" target="_blank">my GitHub respository</a>.
            </p>
